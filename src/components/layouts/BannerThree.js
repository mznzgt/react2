...
class BannerThree extends Component {
    render() {
        return (
            <section className="banner-area-3"  style={{backgroundImage: "url(assets/img/banner/3.png)"}}>
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-lg-10">
                            <div className="banner-inner">
                                <div className="text-center" data-swiper-parallax="300">
                                    <h1 className="text-white">Search Properties</h1>
                                    <h1 className="text-white">For Saleand For Rent</h1>
                                </div>
                                <div>
