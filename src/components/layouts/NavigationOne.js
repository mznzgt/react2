            ...
            <div className="navbar-area">
                <nav className="navbar navbar-expand-lg">
                    <div className="container nav-container">
                        ...
                        <div className="logo">
                            <Link className="main-logo initiate-scripts" to={'/'}><img src={process.env.PUBLIC_URL + '/assets/img/logo.png'} alt="img" /></Link>
                        </div>
                        <div className="nav-right-part nav-right-part-mobile">
                            <Link className="btn btn-base initiate-scripts" to={'/'}>Submit Listing</Link>
                        </div>
                        ...
                        <div className="nav-right-part nav-right-part-desktop">
                            ...
                            <ul>
                                <li><Link className="initiate-scripts" to={'/'}><i className="fa fa-heart" /></Link></li>
                                <li><Link className="initiate-scripts" to={'/'}><i className="fas fa-user" /></Link></li>
